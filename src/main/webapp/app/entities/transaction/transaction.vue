  ...
  <div>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="nhipstertestApp.transaction.delete.question" data-cy="transactionDeleteDialogHeading"
          >Confirm delete operation</span
        ></span
      >
      <div class="modal-body">
        <p id="jhi-delete-transaction-heading">Are you sure you want to delete this Transaction?</p>
      </div>
