...
export default class ProductAttributeTerm extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllProductAttributeTerms();
  }
  ...
  public retrieveAllProductAttributeTerms(): void {
  ...
  public prepareRemove(instance: IProductAttributeTerm): void {
  ...
  public removeProductAttributeTerm(): void {
    this.productAttributeTermService()
      .delete(this.removeId)
      .then(() => {
        const message = 'A ProductAttributeTerm is deleted with identifier ' + this.removeId;
