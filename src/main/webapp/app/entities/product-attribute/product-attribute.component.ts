...
export default class ProductAttribute extends Vue {
  ...
  public retrieveAllProductAttributes(): void {
  ...
  public prepareRemove(instance: IProductAttribute): void {
  ...
  public removeProductAttribute(): void {
    this.productAttributeService()
      .delete(this.removeId)
      .then(() => {
        const message = 'A ProductAttribute is deleted with identifier ' + this.removeId;
