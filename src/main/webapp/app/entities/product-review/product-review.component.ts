...
export default class ProductReview extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllProductReviews();
  }
  ...
  public retrieveAllProductReviews(): void {
  ...
  public prepareRemove(instance: IProductReview): void {
  ...
  public removeProductReview(): void {
    this.productReviewService()
      .delete(this.removeId)
      .then(() => {
        const message = 'A ProductReview is deleted with identifier ' + this.removeId;
