...
export default class ProductImage extends Vue {
  ...
  public retrieveAllProductImages(): void {
  ...
  public prepareRemove(instance: IProductImage): void {
  ...
  public removeProductImage(): void {
    this.productImageService()
      .delete(this.removeId)
      .then(() => {
        const message = 'A ProductImage is deleted with identifier ' + this.removeId;
