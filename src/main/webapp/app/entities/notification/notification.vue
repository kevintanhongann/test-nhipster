  ...
  <div>
      ...
      <table class="table table-striped" aria-describedby="notifications">
        <thead>
          <tr>
            ...
            <th scope="row"><span>Sent Date</span></th>
            <th scope="row"><span>Format</span></th>
            <th scope="row"><span>Google Notification Id</span></th>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="nhipstertestApp.notification.delete.question" data-cy="notificationDeleteDialogHeading"
