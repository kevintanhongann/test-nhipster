...
export default class TaxRate extends Vue {
  ...
  public retrieveAllTaxRates(): void {
  ...
  public prepareRemove(instance: ITaxRate): void {
  ...
  public removeTaxRate(): void {
    this.taxRateService()
      .delete(this.removeId)
      .then(() => {
        const message = 'A TaxRate is deleted with identifier ' + this.removeId;
