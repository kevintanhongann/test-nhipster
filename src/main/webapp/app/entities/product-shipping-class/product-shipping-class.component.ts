...
export default class ProductShippingClass extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllProductShippingClasss();
  }
  ...
  public retrieveAllProductShippingClasss(): void {
  ...
  public prepareRemove(instance: IProductShippingClass): void {
  ...
  public removeProductShippingClass(): void {
    this.productShippingClassService()
      .delete(this.removeId)
      .then(() => {
        const message = 'A ProductShippingClass is deleted with identifier ' + this.removeId;
