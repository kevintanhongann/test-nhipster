...
describe('Service Tests', () => {
  describe('Coupon Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Coupon(0, 'AAAAAAA', 0, DiscountType.PERCENT, 'AAAAAAA', currentDate, false, 0, 0, false, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      it('should find an element', async () => {
        const returnedFromService = Object.assign(
          {
            expiry: dayjs(currentDate).format(DATE_FORMAT),
          },
          elemDefault
        );
        ...
        const returnedFromService = Object.assign(
          {
            ...
            usageLimitPerUser: 1,
            freeShipping: true,
            minimumAmount: 'BBBBBB',
            maximumAmount: 'BBBBBB',
          },
          elemDefault
        );
