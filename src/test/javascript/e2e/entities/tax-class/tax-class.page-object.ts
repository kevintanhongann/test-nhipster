...
export default class TaxClassComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('tax-class-heading'));
...
export class TaxClassDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('nhipstertestApp.taxClass.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-taxClass'));
}
