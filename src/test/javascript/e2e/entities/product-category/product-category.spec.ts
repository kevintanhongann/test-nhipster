...
describe('ProductCategory e2e test', () => {
  ...
  describe('Create flow', () => {
    it('should load create ProductCategory page', async () => {
      ...
      expect(await updatePage.title.getText()).to.match(/Create or edit a ProductCategory/);
    });
    ...
    describe('Details, Update, Delete flow', () => {
      after(async () => {
        ...
        expect(await deleteDialog.title.getAttribute('id')).to.match(/nhipstertestApp.productCategory.delete.question/);
