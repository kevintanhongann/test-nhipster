...
export default class ProductTagComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('product-tag-heading'));
...
export class ProductTagDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('nhipstertestApp.productTag.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-productTag'));
}
