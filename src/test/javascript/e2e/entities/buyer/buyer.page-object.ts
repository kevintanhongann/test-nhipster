...
export default class BuyerComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('buyer-heading'));
...
export class BuyerDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('nhipstertestApp.buyer.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-buyer'));
}
