...
describe('Invoice e2e test', () => {
  ...
  describe('Create flow', () => {
    it('should load create Invoice page', async () => {
      ...
      expect(await updatePage.title.getText()).to.match(/Create or edit a Invoice/);
    });
    ...
    describe('Details, Update, Delete flow', () => {
      after(async () => {
        ...
        expect(await deleteDialog.title.getAttribute('id')).to.match(/nhipstertestApp.invoice.delete.question/);
