...
export default class ItemComponentsPage extends AlertPage {
...
export class ItemDeleteDialog {
  ...
  title: ElementFinder = element(by.id('nhipstertestApp.item.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-item'));
}
