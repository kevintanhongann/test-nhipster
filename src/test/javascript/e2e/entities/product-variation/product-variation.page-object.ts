...
export default class ProductVariationComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('product-variation-heading'));
...
export class ProductVariationDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('nhipstertestApp.productVariation.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-productVariation'));
}
