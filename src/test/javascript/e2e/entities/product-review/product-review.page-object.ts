...
export default class ProductReviewComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('product-review-heading'));
...
export class ProductReviewDeleteDialog {
  ...
  title: ElementFinder = element(by.id('nhipstertestApp.productReview.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-productReview'));
}
