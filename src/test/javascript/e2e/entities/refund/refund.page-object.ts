...
export default class RefundComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('refund-heading'));
...
export class RefundDeleteDialog {
  ...
  title: ElementFinder = element(by.id('nhipstertestApp.refund.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-refund'));
}
