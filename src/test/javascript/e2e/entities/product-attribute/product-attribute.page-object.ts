...
export default class ProductAttributeComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('product-attribute-heading'));
...
export class ProductAttributeDeleteDialog {
  ...
  title: ElementFinder = element(by.id('nhipstertestApp.productAttribute.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-productAttribute'));
}
