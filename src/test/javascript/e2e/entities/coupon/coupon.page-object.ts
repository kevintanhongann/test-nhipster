...
export default class CouponComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('coupon-heading'));
...
export class CouponDeleteDialog {
  ...
  title: ElementFinder = element(by.id('nhipstertestApp.coupon.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-coupon'));
}
