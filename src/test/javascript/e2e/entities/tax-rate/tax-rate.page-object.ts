...
export default class TaxRateComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('tax-rate-heading'));
...
export class TaxRateDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('nhipstertestApp.taxRate.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-taxRate'));
}
