...
export default class TransactionComponentsPage extends AlertPage {
...
export class TransactionDeleteDialog {
  ...
  title: ElementFinder = element(by.id('nhipstertestApp.transaction.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-transaction'));
}
