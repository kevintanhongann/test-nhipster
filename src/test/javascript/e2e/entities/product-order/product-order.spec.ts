...
describe('ProductOrder e2e test', () => {
  ...
  describe('Create flow', () => {
    it('should load create ProductOrder page', async () => {
      ...
      expect(await updatePage.title.getText()).to.match(/Create or edit a ProductOrder/);
    });
    ...
    /* it('should create and save ProductOrders', async () => {
      ...
      await selectLastOption(updatePage.deliveryOptionSelect);
    ...
    describe('Details, Update, Delete flow', () => {
      ...
      after(async () => {
        ...
        expect(await deleteDialog.title.getAttribute('id')).to.match(/nhipstertestApp.productOrder.delete.question/);
