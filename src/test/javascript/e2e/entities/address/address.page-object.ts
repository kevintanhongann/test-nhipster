...
export default class AddressComponentsPage extends AlertPage {
...
export class AddressDeleteDialog {
  ...
  title: ElementFinder = element(by.id('nhipstertestApp.address.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-address'));
}
