...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8081';
  'jhipster.clientApp.name' = 'nhipstertest';
  ...
  'jhipster.mail.from' = 'nhipstertest@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'nhipstertest API';
  'jhipster.swagger.description' = 'nhipstertest API documentation';
  ...
  'eureka.instance.appname' = 'nhipstertest';
  'eureka.instance.instanceId' = 'nhipstertest:${random.value}';
  ...
  'cloud.config.name' = 'nhipstertest';
